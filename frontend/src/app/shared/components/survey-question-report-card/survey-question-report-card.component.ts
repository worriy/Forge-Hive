...
@Component({
  selector: 'app-survey-question-report-card',
  templateUrl: './survey-question-report-card.component.html',
  styleUrls: ['./survey-question-report-card.component.scss'],
})
export class SurveyQuestionReportCardComponent implements OnInit {
