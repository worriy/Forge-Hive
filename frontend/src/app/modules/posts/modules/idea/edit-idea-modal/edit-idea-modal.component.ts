...
import { IdeaControllerService } from 'src/app/services/api/idea-controller.service';
...
export class EditIdeaModalComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public _ideaController: IdeaControllerService,
  ...
  public async ngOnInit() {
    ...
    this.onGetTargetableGroups().then(() => 
    {
      ...
      this._ideaController.getEditableIdea(this.post.id).subscribe(data => 
      {
        ...
        this.ideaForm.controls.targetGroups.patchValue(this.editablePost.targetGroupsIds);
  ...
  public async onSaveChanges() {
    ...
    if(this.smallImg)
    {
      ...
      return this._pictureController.create(pic).subscribe((res: string) =>
      {
        ...
        //then save the post
        this._ideaController.update(editVM);
        loading.dismiss();
