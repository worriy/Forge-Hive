...
export class EditSuggestionModalComponent implements OnInit {
  ...
  @Input() post: Post;
  editablePost: EditableSuggestion;
  ...
  public async ngOnInit() {
    ...
    this.onGetTargetableGroups().then(() => 
    {
      ...
      this._suggestionController.getEditableSuggestion(this.post.id).subscribe(data => 
      {
        ...
        console.log(this.editablePost.targetGroupsIds);
        ...
        this.suggestionForm.controls.targetGroups.patchValue(this.editablePost.targetGroupsIds);
  ...
  public async onSaveChanges() {
    ...
    if(this.smallImg)
    {
      ...
      return this._pictureController.create(pic).subscribe((res: string) =>
      {
        ...
        //then save the post
        this._suggestionController.update(editVM);
        loading.dismiss();
