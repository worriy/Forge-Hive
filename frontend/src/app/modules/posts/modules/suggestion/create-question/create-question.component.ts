...
@Component({
  selector: 'suggestion-create-question',
...
export class CreateQuestionComponent implements OnInit {
  ...
  @Input() vm: CreateSuggestion;
  @Input() utils: CreationUtils;

  @Output() changes = new EventEmitter<CreateSuggestion>();
  ...
  public onGetDefaultPicture() {
    return this._suggestionController.getDefaultPicture().subscribe(data => {
