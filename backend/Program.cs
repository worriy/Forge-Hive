...
namespace Hive.Backend
{
    public class Program
    {
        ...
        private static Guid startSurveyChoiceId;
        ...
        private static Guid surveyDefaultPicId;
        private static Guid moodDefaultPicId;
        private static Guid quoteDefaultPicId;
        ...
        public static Guid QuoteDefaultPicId { get => quoteDefaultPicId; set => quoteDefaultPicId = value; }
        public static Guid MoodDefaultPicId { get => moodDefaultPicId; set => moodDefaultPicId = value; }
        public static Guid SurveyDefaultPicId { get => surveyDefaultPicId; set => surveyDefaultPicId = value; }
        ...
        public static Guid StartSurveyChoiceId { get => startSurveyChoiceId; set => startSurveyChoiceId = value; }
